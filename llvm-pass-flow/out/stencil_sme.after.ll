...
23:                                               ; preds = %15
  %24 = tail call aarch64_sme_preservemost_from_x2 { i64, i64 } @__arm_sme_state() #22
...
42:                                               ; preds = %29
  %43 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %33) #23
...
46:                                               ; preds = %42
  ...
  %50 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %33) #23
...
255:                                              ; preds = %254, %228, %151
  %256 = phi i64 [ 1, %151 ], [ %149, %254 ], [ %146, %228 ]
  br label %306

257:                                              ; preds = %303
  %258 = load ptr, ptr %4, align 8, !tbaa !18
  %259 = call { ptr, ptr, i32, i32 } asm sideeffect ".inst 0xd503437f\0Abl _stencil2d5p_sme_kernel\0A.inst 0xd503427f", "={x0},={x1},={w2},={w3},{x0},{x1},{w2},{w3},~{x4},~{x5},~{x6},~{x7},~{x8},~{x9},~{x10},~{x11},~{x12},~{x13},~{x14},~{x15},~{x16},~{x17},~{memory}"(ptr nonnull %34, ptr %258, i32 range(i32 3, -2147483648) %16, i32 range(i32 3, -2147483648) %17) #24, !srcloc !42
...
345:                                              ; preds = %299
  ...
  %349 = sub i64 %347, %348
  call void @_ZdlPvm(ptr noundef nonnull %301, i64 noundef %349) #26
  br label %350
...
define linkonce_odr hidden void @_ZNSt3__16vectorIfNS_9allocatorIfEEE20__throw_length_errorB9nqe220108Ev() local_unnamed_addr #8 {
  tail call void @_ZNSt3__120__throw_length_errorB9nqe220108EPKc(ptr noundef nonnull @.str.2) #25
  unreachable
}
